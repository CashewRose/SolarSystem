...
const emailArray = customers.map(function (info) {
    const val = info.contacts.email;
        return val;
})

console.log(emailArray);

const bigEmailArray = emailArray[0].concat(emailArray[1]).concat(emailArray[2]).concat(emailArray[3]).concat(emailArray[4]).concat(emailArray[5]).concat(emailArray[6]).concat(emailArray[7]).concat(emailArray[8]).concat(emailArray[9]);


console.log(bigEmailArray);